...
export default function MagnifyingSection() {
  ...
  return (
    ...
    >
      ...
      {/* Magnifier lens */}
      <div
        className="absolute w-40 h-40 rounded-full border-2 border-white pointer-events-none hidden xl:block"
        style={{ left: pointer.x - 80, top: pointer.y - 80 }}
      />
      <div
        className="absolute w-2 h-20 bg-white pointer-events-none hidden xl:block"
        style={{
          left: pointer.x - 60,
          top: pointer.y + 50,
